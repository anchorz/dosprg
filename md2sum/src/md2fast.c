...
*             based on md2.c by Brad Conte (brad AT bradconte.com)
* Copyright:
...
#if defined(__BCC__)
#include "md2fast_transform_asm.c"
#else
#include "md2fast_transform.c"
#endif
